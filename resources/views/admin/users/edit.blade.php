{{-- ========= ADMIN USER EDIT ========= --}}
{{-- Edit user form layout; loading and submission are handled by the page script. --}}
        ...
        <div
            ...
            <div class="w-full max-w-[560px] rounded-2xl bg-white shadow-2xl">
                <div class="border-b border-slate-200 px-6 py-4">
                    <h3 class="text-lg font-semibold text-slate-800">Confirm Update User</h3>
                    <p class="mt-1 text-sm text-slate-500">Please review these account changes before they are saved.</p>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 border-t border-slate-200 px-6 py-4">
                    ...
                    <button
                        ...
                        :disabled="submitting"
                        class="rounded bg-slate-900 px-5 py-2 text-sm text-white shadow hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60">
                        <span x-text="submitting ? 'Saving...' : 'Confirm Update'"></span>
                    </button>
                </div>
            </div>
        </div>
