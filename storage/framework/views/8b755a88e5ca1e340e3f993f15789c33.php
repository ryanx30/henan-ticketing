...
<body>
    ...
    <div class="meta">
        Search:
        <?php echo e($filters['q'] ?: '-'); ?>

        &nbsp;|&nbsp;

        Date:
        <?php echo e($filters['date_from'] ?: '-'); ?>

        →
        <?php echo e($filters['date_to'] ?: '-'); ?>

        &nbsp;|&nbsp;

        Sort:
        <?php echo e($filters['sort_by']); ?>

        (<?php echo e(strtoupper($filters['sort_dir'])); ?>)
        &nbsp;|&nbsp;
...
</html><?php /**PATH C:\laragon\www\henan-ticketing\resources\views/exports/history-pdf.blade.php ENDPATH**/ ?>