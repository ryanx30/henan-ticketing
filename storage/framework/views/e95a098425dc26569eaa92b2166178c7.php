...
<div x-show="!isSupervisor()" class="overflow-hidden rounded bg-white shadow-lg">
    <div class="flex items-center justify-between border-b bg-slate-50 px-4 py-4">
        ...
        <a href="<?php echo e(route('tickets.index', ['mine' => 1, 'status' => 'all'])); ?>" class="text-sm text-gray-700 underline hover:text-slate-950">
            Open
        </a>
    </div>
...
<?php /**PATH C:\laragon\www\henan-ticketing\resources\views/dashboard/partials/cs-my-tickets.blade.php ENDPATH**/ ?>