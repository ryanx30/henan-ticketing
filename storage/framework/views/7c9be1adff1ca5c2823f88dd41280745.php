...
<?php $component->withAttributes([]); ?>
    ...
    <div
        ...
        data-message-id="<?php echo e($resolverMessage->id); ?>"
        ...
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div class="flex items-start gap-4">
                    <a
                        href="<?php echo e(route('resolver-inbox.index')); ?>"
                        data-smart-back
                        data-fallback-url="<?php echo e(route('resolver-inbox.index')); ?>"
                                            ...
                                            <div class="relative shrink-0">
                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        ...
                                                        <img src="<?php echo e(asset('images/icons/reply.png')); ?>" alt="" class="h-4 w-4 object-contain">
                                                        <span>Reply</span>
                                                    </button>
                                                    <button
                                                        type="button"
                                                        ...
                                                        class="flex w-full items-center gap-3 px-4 py-2.5 text-left text-slate-700 hover:bg-slate-50">
                                                        <img src="<?php echo e(asset('images/icons/copy.png')); ?>" alt="" class="h-4 w-4 object-contain">
                                                        <span>Copy</span>
                                                    </button>
                                                    <button
                                                        type="button"
                                                        ...
                                                        <img src="<?php echo e(asset('images/icons/delete.png')); ?>" alt="" class="h-4 w-4 object-contain">
                                                        <span>Delete</span>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <form @submit.prevent="submitReply" class="border-t border-slate-200 bg-white px-5 pt-2 pb-2">
                            ...
                            <div class="flex items-center gap-3 rounded-[26px] border border-slate-200 bg-slate-50 px-4 py-1.5 shadow-sm transition focus-within:border-slate-300 focus-within:bg-white">
                                ...
                                <button
                                    ...
                                    <img src="<?php echo e(asset('images/icons/send.png')); ?>" alt="" class="h-4 w-4 object-contain">
                                </button>
                            </div>
                        </form>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\henan-ticketing\resources\views/resolver-inbox/show.blade.php ENDPATH**/ ?>