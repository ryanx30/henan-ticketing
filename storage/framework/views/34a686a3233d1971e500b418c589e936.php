        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div
                x-data="ticketEditForm({
                    ticketId: <?php echo e((int) $ticketId); ?>,
                    loadUrl: '/api/tickets/<?php echo e((int) $ticketId); ?>',
                    submitUrl: '/api/tickets/<?php echo e((int) $ticketId); ?>',
                    submitMethod: 'PATCH',
                })"
                x-init="init()"
            >
                            ...
                            <div class="grid grid-cols-3 items-center mb-6">
                                <div>
                                    <a href="<?php echo e(route('tickets.index')); ?>"
                                       data-smart-back
                                       data-fallback-url="<?php echo e(route('tickets.index')); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\henan-ticketing\resources\views/tickets/edit.blade.php ENDPATH**/ ?>