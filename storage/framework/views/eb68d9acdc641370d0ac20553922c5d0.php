                    ...
                    <table class="w-full text-sm text-slate-800">
                        ...
                        <tbody>
                            ...
                            <template x-for="(row, index) in rows" :key="row.id">
                                <tr
                                    class="report-ticket-row border-t border-slate-200"
                                    :class="index % 2 === 0 ? 'bg-white' : 'bg-[#dfe8ee]'"
                                    @click="openTicket(row)"
                                    tabindex="0"
                                    @keydown.enter.prevent="openTicket(row)">
                                    <td class="px-5 py-3 font-semibold text-[#051823]" x-text="row.ticket_code"></td>
