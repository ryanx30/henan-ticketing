                    ...
                    <tr :class="index % 2 === 0 ? 'border-t border-slate-200 bg-white' : 'border-t border-slate-200 bg-[#dfe8ee]'">
                        ...
                        <td class="px-3 py-3">
                            <div class="flex items-center justify-end gap-1.5">
                                ...
                                <template x-if="canEditTicket(ticket)">
                                    <a
                                ...
                                <template x-if="!canEditTicket(ticket)">
                                    <button
                                        type="button"
                                        disabled
                                        :title="editDisabledTitle(ticket)"
                                        class="inline-flex h-8 cursor-not-allowed items-center justify-center rounded-lg bg-slate-300 px-2.5 text-xs font-semibold text-slate-500 shadow-sm">
                                        Edit
                                    </button>
                                </template>
                            </div>
